<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small">
            <span class="menu-header-text" data-i18n="Manajemen Toko">Manajemen Toko</span>
        </li>

        <li class="menu-item {{ Request::routeIs('sales.sale', 'sales.preview') ? 'open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Request::routeIs('sales.sale') ? 'active' : '' }}">
                    <a href="{{ route('sales.sale') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::routeIs('sales.product') ? 'active' : '' }}">
        ...
        <li class="menu-header small">
            <span class="menu-header-text" data-i18n="Agenda">Agenda</span>
        </li>
