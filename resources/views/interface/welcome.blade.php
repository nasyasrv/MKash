    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section id="hero-animation">
            <div id="landingHero" class="section-py landing-hero position-relative">
                <img src="{{ asset('assets_admin/img/front-pages/backgrounds/hero-bg.png') }}" alt="hero background"
                    ...
                    <div class="hero-text-box text-center position-relative">
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Join community
                                <img src="{{ asset('assets_admin/img/front-pages/icons/Join-community-arrow.png') }}"
            ...
            <div class="container">
                ...
                <h4 class="text-center mb-1">
                    <span class="position-relative fw-extrabold z-1">Everything you need
                        <img src="{{ asset('assets_admin/img/front-pages/icons/section-title-icon.png') }}"
                            alt="laptop charging"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                {{-- <div class="mb-4">
                                                    <img src="{{ asset('assets_admin/img/front-pages/branding/logo-2.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div> --}}
                                                <div class="bg-label-primary rounded text-center mb-4 pt-4 shimmer-hover">
                                                    <img class="img-fluid"
                                                        src="../../assets_admin/img/illustrations/girl-with-laptop.png"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    {{-- <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ asset('assets_admin/img/avatars/2.png') }}"
            ...
            {{-- <div class="container">
                <div class="swiper-logo-carousel py-8">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('assets_admin/img/front-pages/branding/logo_1-light.png') }}"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('assets_admin/img/front-pages/landing-page/team-member-1.png') }}"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('assets_admin/img/front-pages/landing-page/team-member-2.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('assets_admin/img/front-pages/landing-page/team-member-3.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('assets_admin/img/front-pages/landing-page/team-member-4.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
        ...
        <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
            <img src="{{ asset('assets_admin/img/front-pages/backgrounds/cta-bg-light.png') }}"
            ...
            <div class="container">
                <div class="row align-items-center gy-12">
                    ...
                    <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
                        <img src="{{ asset('assets_admin/img/front-pages/landing-page/cta-dashboard.png') }}"
