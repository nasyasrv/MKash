<footer class="landing-footer bg-body footer-text">
      <div class="footer-top position-relative overflow-hidden z-1">
        <img
          src="{{ asset('assets_admin/img/front-pages/backgrounds/footer-bg-light.png')}}"
          alt="footer bg"
        ...
        <div
          ...
          <div>
            <a href="https://github.com/pixinvent" class="me-3" target="_blank">
              <img src="{{ asset('assets_admin/img/front-pages/icons/github.svg')}}" alt="github icon" />
            </a>
            <a href="https://www.facebook.com/pixinvents/" class="me-3" target="_blank">
              <img src="{{ asset('assets_admin/img/front-pages/icons/facebook.svg')}}" alt="facebook icon" />
            </a>
            <a href="https://twitter.com/pixinvents" class="me-3" target="_blank">
              <img src="{{ asset('assets_admin/img/front-pages/icons/twitter.svg')}}" alt="twitter icon" />
            </a>
            <a href="https://www.instagram.com/pixinvents/" target="_blank">
              <img src="{{ asset('assets_admin/img/front-pages/icons/instagram.svg')}}" alt="google icon" />
            </a>
          </div>
        </div>
      </div>
