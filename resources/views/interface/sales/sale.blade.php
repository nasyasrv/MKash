                ...
                <div class="card invoice-preview-card p-sm-12 p-6">
                   <div class="card-body invoice-preview-header rounded">
                                        ...
                                        <div class="row w-100 p-6">
                                            <div class="col-md-5 col-12 mb-md-0 mb-4">
                                                ...
                                                <select class="form-select item-details mb-6">
                                                    ...
                                                    <option value="App Customization" selected>Nama Produk</option>
                                                    <option value="ABC Template">ABC Template</option>
                                                    <option value="App Development">App Development</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                <p class="h6 repeater-title">Jumlah Produk</p>
                                                <input type="number" class="form-control invoice-item-price mb-5"
                                                    placeholder="24" min="12" />
                                            </div>
                                            <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                <p class="h6 repeater-title">Harga Produk</p>
                                                <input type="number" class="form-control invoice-item-qty" placeholder="1"
                                                    min="1" max="50" />
                                            </div>
                                            <div class="col-md-3 col-12 pe-0 mt-md-2">
                                                <p class="h6 repeater-title">Total</p>
                                                <p class="mb-0 text-heading">Rp24.00</p>
                                            </div>
                                        </div>
                                        <div
                    ...
                    <div class="card-body pt-0 px-0">
                        <form class="source-item">
                            <div class="mb-4" data-repeater-list="group-a">
                                <div class="repeater-wrapper pt-0 pt-md-33" data-repeater-item>
                                    <div class="d-flex border rounded position-relative pe-0">
                                        <div class="row w-100 p-6">
                                            <div class="col-md-5 col-12 mb-md-0 mb-4">
                                                <p class="h6 repeater-title">Nama Produk</p>
                                            ...
                                            <div class="col-md-2 col-12 pe-0 mt-md-2">
                                                <p class="h6 repeater-title">Total</p>
                                                <p class="mb-0 text-heading">Rp.100.000</p>
                                            </div>
                                        </div>
                                        <div
                                            class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                    ...
                    <div class="card-body px-0">
                        <div class="row row-gap-4">
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-md-3">
                                    <label for="customer" class="form-label fw-bold">Nama Pelanggan</label>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-3 ms-auto">
                                <div class="invoice-calculations">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="fw-medium text-heading">Rp.1800</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="w-px-100">Discount:</span>
                                        <span class="fw-medium text-heading">Rp.28</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="fw-bold text-heading-price" style="color: red;">Rp.1690</span>
                                    </div>
                                </div>
                            </div>
