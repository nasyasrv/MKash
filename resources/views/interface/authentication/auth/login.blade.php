        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets_admin/img/illustrations/auth-login-illustration-light.png') }}"
                        alt="auth-login-cover" class="my-5 auth-illustration"
                        data-app-light-img="illustrations/auth-login-illustration-light.png"
                        data-app-dark-img="illustrations/auth-login-illustration-dark.png" />

                    <img src="{{ asset('assets_admin/img/illustrations/bg-shape-image-light.png') }}"
            ...
            <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
                <div class="w-px-400 mx-auto mt-12 pt-5">
                    <h4 class="mb-1">Selamat datang di Micash! 👋</h4>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text"class="form-control @error('email') is-invalid @enderror"
                                ...
                                autofocusid="email" placeholder="Masukkan email atau nama pengguna anda" autofocus />
                            @error('email')
