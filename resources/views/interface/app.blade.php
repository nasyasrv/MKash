  ...
  <body>
    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
      <div class="layout-container">
         <!-- Navbar -->
            @include('interface.layout.navbar1')
          <!-- / Navbar -->
          <!-- Layout container -->
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <!-- Menu -->
            @include('interface.layout.navbar2')
            <!-- / Menu -->
    ...
    <script src="{{asset('assets_admin/vendor/libs/chartjs/chartjs.js')}}"></script>
    ...
    <script src="{{asset('assets_admin/js/charts-chartjs.js')}}"></script>
  </body>
</html>
